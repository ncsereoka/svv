...
public final class ResourceUtil {
	public static byte[] readResourceFile(Class<?> clazz, String url) throws URISyntaxException, IOException {
		return Files.readAllBytes(Paths.get(Objects.requireNonNull(clazz.getClassLoader().getResource(url)).toURI()));
	}

	public static File loadResourceFile(Class<?> clazz, String url) throws URISyntaxException {
